      ...
      'project': {
        'project': [{
          ...
          'contents': ['티몬을 모티브로한 소셜커머스 웹 서비스 제작', `
              <br />
              - [프로젝트 작업] : 전체적인 제안, 기획, 설계 / Framework설계 / DB설계 / 프로젝트 전체 통합 / 팀 일정관리<br /><br />
              - [메인 작업] : 스크롤페이징 / 롤링카운터 / 상단 메뉴 제작 / 상품 메뉴 제작 / 인기상품 top10 / Other's deal 관리 / 기업회원 개인페이지 / 관리자 페이지 / 일반회원 접속여부 확인 / 등급관리 기능 / 테이블 개수 제한 더보기-접어두기 페이징(스크롤) / 일반회원 통계 관리 페이지 구현 / 기업회원 통계 관리 페이지 구현 / 인기기업, 판매 딜 많은 기업, 위험 기업 순위 적용 / 등급에 따른 할인 및 매출 계산 구현 / 구매고객 리스트 / 딜 수량 수정기능 / 딜 삭제 기능 / 기업정보 수정 기능 / 기업정보 삭제 기능 / 매출 등급 / 기업 등급상태 기능 제작.<br /><br />

...
module.exports = {
  ...
  detailContents: {
    ...
    'IT Bank (아이티뱅크)': {
      ...
      'info': '개발자 준비 교육 아카데미.',
      'service': ['Project<br /> - <a href="http://jeromebaek-portfolio-en.ml/portfolio/proj01_dasam.html">Project01 _ DASAM ( 소셜커머스 )<a/>'],
      'project': {
        'project': [{
